...
//Account Update
exports.sendAccountUpdate = (email, password, fullname, roles) => {
    const mailOptions = {
        from: process.env.EMAIL_USER,
        to: email,
        ...
        <body>
            <div class="container">
                ...
                <p>Dear ${fullname},</p>
                <p>We are pleased to inform you that your account has been successfully updated. Please find below your login credentials:</p>
                <ul>
                    <li><strong>Username: </strong> ${email}</li>
                    <li><strong>Password: </strong>${password}</li>
                    <li style={{ textTransform: 'capitalize' }}><strong>Role: </strong>${roles}</li>
    ...
    transporter.sendMail(mailOptions, function (error, info) {
        if (error) {
            ...
            console.log('Account Update sent: ' + info.response);
        }
    });
};